...
FitFlow is a personal fitness and nutrition companion that runs entirely on your device. It combines a massive food database, an AI coach, workout content, and habit tracking into a single app — all without requiring an account or sending any data to a server.
...
- **100% Private** — All data is stored locally via IndexedDB (web) or on-device storage (mobile). Nothing leaves your device.
